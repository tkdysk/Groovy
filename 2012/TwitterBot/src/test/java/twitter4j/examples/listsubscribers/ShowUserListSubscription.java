...
public final class ShowUserListSubscription {
    /**
     * Usage: java twitter4j.examples.listsubscribers.ShowUserListSubscription [list id] [user id]
     *
     * @param args message
     */
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java twitter4j.examples.listsubscribers.ShowUserListSubscription [list id] [user id]");
            System.exit(-1);
        }
        try {
